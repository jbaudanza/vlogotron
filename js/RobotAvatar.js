...
export default function RobotAvatar(props: Props) {
  let mouth;
  if (props.open) {
    mouth = (
      <circle fill={props.colors.mouth} cx="17" cy="23" r="2" strokeWidth="3" />
    );
  } else {
    mouth = (
      <path
        fill={props.colors.mouth}
        d="M16.735 24.72c-1.844 0-3.288-1.158-3.288-2.637h1.174c0 .78.968 1.439 2.114 1.439v1.198z M16.559 24.72v-1.198c1.146 0 2.114-.659 2.114-1.439h1.174c0 1.479-1.444 2.637-3.288 2.637"
      />
    );
  }
    ...
    >
      ...
      <g fill="none" fillRule="evenodd" transform="translate(2 2)">
        ...
        <g transform="translate(7 7.027)">
          ...
          <path
            fill={props.colors.outline}
            d="M5.109 21.877H2.23C1.001 21.877 0 20.694 0 19.24c0-1.453 1-2.636 2.231-2.636H5.11v1.198H2.23c-.573 0-1.057.659-1.057 1.438 0 .78.484 1.438 1.057 1.438H5.11v1.199z"
          />
          <path
            fill={props.colors.outline}
            d="M30.763 21.877h-2.877v-1.199h2.877c.573 0 1.057-.658 1.057-1.438 0-.78-.484-1.438-1.057-1.438h-2.877v-1.198h2.877c1.23 0 2.231 1.183 2.231 2.636 0 1.454-1 2.637-2.23 2.637"
          />
          <path
            fill={props.colors.outline}
            d="M10.578 17.802c-.777 0-1.41.645-1.41 1.438 0 .793.633 1.438 1.41 1.438.777 0 1.409-.645 1.409-1.438 0-.793-.632-1.438-1.41-1.438m0 4.075c-1.424 0-2.583-1.183-2.583-2.637 0-1.453 1.16-2.636 2.584-2.636 1.424 0 2.583 1.183 2.583 2.636 0 1.454-1.159 2.637-2.583 2.637"
          />
          <path
            fill={props.colors.outline}
            d="M22.372 17.802c-.777 0-1.41.645-1.41 1.438 0 .793.633 1.438 1.41 1.438.777 0 1.41-.645 1.41-1.438 0-.793-.633-1.438-1.41-1.438m0 4.075c-1.425 0-2.584-1.183-2.584-2.637 0-1.453 1.16-2.636 2.584-2.636 1.425 0 2.584 1.183 2.584 2.636 0 1.454-1.16 2.637-2.584 2.637"
          />
          {mouth}
          <mask id="svg-robot-avatar-b" fill={props.colors.eyes}>
