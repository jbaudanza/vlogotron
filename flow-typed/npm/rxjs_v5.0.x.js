...
declare class rxjs$Observable<+T> {
  ...
  // JB - Adding missing static definition
  ...
  // JB - withLatestFrom definitions with resultSelectors are broken.
  // See https://github.com/flowtype/flow-typed/pull/260
  withLatestFrom<A, B>(
    a: rxjs$Observable<A>,
